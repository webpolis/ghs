...
from .github_client import GitHubStarsFetcher
from .readme_parser import ReadmeFetcher
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  ghs fetch                          # Fetch and index all starred repos
  ghs search "machine learning"      # Search for repos
  ghs refresh                        # Sync added/removed stars
  ghs stats                          # Show database statistics
        """
    )
